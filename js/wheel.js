...
const innerRadii =[40,80,140];
const outerRadii =[80,140,200];
const ringnr = 3;
const steps =85;
const circlex=230;
const circley=230;
...
//Teken de slice
const drawSlice = (flavor) => {
  //benoem in één keer 6 variabelen, uit de flavor te halen
  const {ring, fromStep,toStep, color, name, id} = flavor;
  ...
  const angle = (((fromStep+toStep)/steps)*180)-89.1;
  let textAngle = angle;
  ...
  //3. zoek de daadwerkelijke elementen met die is.
